...
public class Main {
    public static void main(String[] args) {
        ...
        books.forEach(book -> map.put(book.getBookName(), book.getAuthorName()));
        ...
        books100.forEach(book -> System.out.println("Book Name: " + book.getBookName() + ", Page Count: " + book.getPageCount()));
